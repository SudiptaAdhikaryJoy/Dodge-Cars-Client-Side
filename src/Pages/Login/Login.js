        ...
        <Container>
            <Grid container spacing={2}>
                <Grid item sx={{mt : 8}} xs={12} md={6} sm={12} lg={6}>
                    ...
                    <form onSubmit={handleLoginSubmit}>
                        ...
                        <TextField
                         ...
                         <NavLink style={{textDecoration: 'none'}} to="/register">
                            <Button sx={{ width: '75%', m:1}} variant="text">Already Register?</Button>
                         </NavLink>
                        {
                    ...
                    <p>-----------or----------</p>
                    <Button onClick={handleGoogle} sx={{ width: '75%', m:1}} variant="contained" type="submit">Google Sign In</Button>
                </Grid>
